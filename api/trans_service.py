...
async def trans_bank_fetch_flow(phone_number: str) -> dict:
    try:
        ...
        return JSONResponse(
            ...
            content={
                "success": False,
                "error": str(e),  # This will include the actual error message
                "trace": traceback.format_exc(),  # Optional: full traceback for debugging
                "message": "An internal error occurred, but we are returning gracefully."
            }
        )
