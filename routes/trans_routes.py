...
from models.request_models import SendOTPRequest, VerifyOTPRequest, VerifyOtpResponse

router = APIRouter()


@router.post("/primePan", tags=["transbnk"], response_model=VerifyOtpResponse)
async def verify_otp_and_pan_route(request: VerifyOTPRequest) -> VerifyOtpResponse:
